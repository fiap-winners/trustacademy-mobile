...
Devido às diferenças entre as várias versões do Android, para garantir o correto funcionamento do aplicativo, após realizar a instalação acesse as configurações e habilite o acesso do Trust Academy à câmera e ao armazenamento.
